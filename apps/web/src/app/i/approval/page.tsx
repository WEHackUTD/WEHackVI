...
export default function Page() {
	return (
		<main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col items-center justify-center bg-background px-4 py-4 sm:px-6">
			...
			<h1 className="mb-10 text-4xl font-extrabold text-hackathon dark:bg-gradient-to-t dark:from-hackathon/80 dark:to-white dark:bg-clip-text dark:text-transparent sm:text-6xl md:text-8xl">
				{c.hackathonName}
			</h1>
			<div className="relative flex aspect-video w-full max-w-[500px] flex-col items-center justify-center rounded-xl bg-white p-5 backdrop-blur transition dark:bg-white/[0.08]">
				<h1 className="text-center text-xl font-bold text-[#07005F] sm:text-2xl">
					{/* <CheckCircleIcon /> */}
