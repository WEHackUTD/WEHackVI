export default async function page() {
    return(
        ...
        <div className="flex flex-col flex-wrap justify-center gap-y-5 gap-x-5 lg:px-24">
          ...
          {/* SATURDAY LUNCH */}
          <div className="flex flex-col flex-start bg-[#1E2A44] border border-b-2 border-[#992444] rounded-[1.5rem] py-10 md:px-10 h-auto gap-y-5">
          ...
          {/* MIDNIGHT SNACK */}
          <div className="flex flex-col flex-start bg-[#1E2A44] border border-b-2 border-[#992444] rounded-[1.5rem] py-10 md:px-10 h-auto gap-y-5 max-w-1/2">
